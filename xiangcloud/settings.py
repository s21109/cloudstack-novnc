# Django settings for xiangcloud project.
import os
import logging
...
ROOT_URLCONF = 'xiangcloud.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'xiangcloud.wsgi.application'
...
if not SECRET_KEY:
    ...
    from xiangcloud.utils import secret_key
